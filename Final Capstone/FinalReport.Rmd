...
```{r 2ndcorrelation, include=FALSE}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#                                    CORRELATION
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
```{r Linear Regression, include=FALSE, eval=F}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#                                   Linear Regression
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
round(accuracy(prediction, trueValues), 3) # Compares models for ME:MAPE above
...
```{r accurcy, echo=FALSE}
model <- lm(SalePrice ~., combined)
trueValues <- combined[1:1458, "SalePrice"]
prediction <- as.vector(round(predict(model), 0))
...
```{r qq plot, echo=FALSE, warning=F}
par(mfrow=c(2,2))
plot(model) # no apparent heteroscedasticity, Q-Q plot needs some scaling effects to fix. No eggregious outliers
```
